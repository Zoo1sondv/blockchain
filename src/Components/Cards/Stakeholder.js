    ...
    <div className="col-12 col-lg-6 my-1">
      <div className="row d-flex justify-content-around align-items-center">
        ...
        <div className="col-12 col-md-8">
          <span className="card-key">Khóa công khai: {stakeholder.formattedAddress}</span>
          <br/>
          <span className="card-key">Tên của bạn: </span>
          <span className="card-value">{stakeholder.name}</span>
          <br/>
          <span className="card-key">Địa chỉ của bạn: </span>
          <span className="card-value">{stakeholder.location}</span>
          <br/>
          <span className="card-key">Vai trò của bạn: </span>
